                    ...
                    <div class="c-search-result">
                        ...
                        <div class="o-media">
                            ...
                            <div class="o-media__body">
                                ...
                                <p class="c-search-result__meta"><?php echo $reguler->agenda; ?> <br> Reguler | <?php echo $reguler->jumlah_sesi; ?> | <?php echo 'Rp ', $reguler->harga, ',-'; ?> | <?php echo $reguler->durasi, ' Menit'; ?> </p>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-6">
