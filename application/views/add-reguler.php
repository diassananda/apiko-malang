...
<div class="col-md-7 col-xl-6">
  <main>
    ...
    <h2 class="u-h3 u-mb-small">Reguler Control</h2>

    <div class="c-card u-p-medium u-text-small u-mb-small">
      <h6 class="u-text-bold">Tambah Reguler</h6>
      <form class="" action="<?php echo site_url('regulers/create_reguler') ?>" method="post">
        <div class="col-sm-12">
          <div class="row u-mb-medium">
            <div class="c-field">
              <label class="c-field__label" for="input13">Jumlah Sesi</label>
              <input class="c-input" type="number" name="jumlah_sesi" id="jumlah_sesi" placeholder="Jumlah Sesi" required>
            </div>
          </div>
          <div class="row u-mb-medium">
            <div class="c-field">
